...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(" " + yourName + " please, enter your height to know if you can play with the toy:");
		...
		if (yourHeight < MINIMUN_HEIGHT) {
			...
			System.out.println("Hello " + yourName + ", you're allowed to play with the toy!");
		}
